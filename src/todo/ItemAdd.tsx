...
const ItemAdd: React.FC<ItemAddProps> = ({ history, match }) => {
    const { items, updating, updateError, saveItem } = useContext(ItemContext);
    ...
    }, [item, saveItem, cod, categorie, pretStr, pietre, data, history]);
